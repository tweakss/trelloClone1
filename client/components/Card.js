...
const Card = (props) => {
  ...
  // const cardBtnTitleDrop = (event) => {
  //   console.log("cardBtnTitleDrop, event.target:", event.target, "list.cards:", list.cards);
  //   // console.log("dataTransfer.items:", event.dataTransfer.items["0"], event.dataTransfer.items["1"], event.dataTransfer.items["2"]);

  //   event.preventDefault();
    
  //   if(!event.target.className.includes("card-btn")) {
  //     console.log("!event.target.className.includes('card-btn')")
  //     return;
  //   }
  ...
  //   const moveToCardPosition = parseInt(event.target.dataset.cardIndex, 10) + 1;
  //   // const moveToListIndex = parseInt(event.target.dataset.listIndex, 10);
  //   const moveToListIndex = listIndex;
  //   const moveToCardIndex = parseInt(event.target.dataset.cardIndex, 10);
  //   console.log("moveToListIndex:", moveToListIndex, "moveToCardIndex:", moveToCardIndex)
  //   const moveToCardId = lists[moveToListIndex].cards[moveToCardPosition - 1].id;
  //   let newPosition;
  //   const eventClientHeight = parseInt(event.target.clientHeight, 10);
  ...
  //   if(draggedCard.leaveListIndex !== listIndex) {
  //     console.log("draggedCard.leaveListIndex !== dropTargetListIndex");
  //     dropDraggedCard({ 
  //       targetListCardToIndex, draggedListCardToIndex,
  //       moveToListIndex, moveToCardIndex,
  ...
  //     // } else {
  //     //   console.log("cardBtnTitleDrop, NOT TOP OR BOTTOM diff list, offsetY:", event.offsetY);
  //     // }

  //   } else {
  //     // if(draggedCard.card.listId === list.cards[cardIndex].listId) {
  //     console.log(`draggedCard.leaveListIndex ${draggedCard.leaveListIndex} === listIndex ${listIndex}`);
  //     dropDraggedCard({ 
  ...
  //   // if( (event.offsetY > Math.floor(eventClientHeight/2)) && (draggedCard.leaveCardIndex < cardIndex) ) {
  //   //   console.log("cardBtnTitleDrop, offsetY > eventClientHeight/2");

  //   //   if(moveToListIndex === draggedListIndex) {
  //   //     //Swap card positions within same list
  //   //     console.log("moveToListIndex === draggedListIndex");
  ...
  //   //     //   moveToListIndex,
  //   //     //   moveToCardIndex: event.target.dataset.cardIndex
  //   //     // })
  ...
  //   //     // console.log("moveCardToList");
  //   //     // moveCardToList({
  //   //     //   moveToListId: lists[moveToListIndex].id,
  //   //     //   //moveToCardPosition,
  //   //     //   newPosition,
  //   //     //   moveToCardId, 
  //   //     //   currListId: list.id,
  //   //     //   currCardPosition: card.cardPosition,
  //   //     //   draggedCardId,
  //   //     //   boardId: board.id,
  ...
  //   //   newPosition = moveToCardPosition + 1;
  //   // } else if( (event.offsetY <= Math.floor(eventClientHeight/2)) && (draggedCard.leaveCardIndex > cardIndex) ) {
  //   //   console.log("cardBtnTitleDrop, offsetY <= eventClientHeight/2");
  //   //   newPosition = moveToCardPosition - 1;
